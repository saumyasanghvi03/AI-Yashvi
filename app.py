...
from langchain_community.embeddings import HuggingFaceEmbeddings  # For free local embeddings
...
def create_qa_chain(vector_store):
    ...
    try:
        ...
        llm = ChatGoogleGenerativeAI(
            model="gemini-1.5-flash",  # Faster & cheaper than 1.5-pro; fallback to "gemini-1.5-pro" if needed
            google_api_key=GEMINI_API_KEY,
            temperature=0.3,
            convert_system_message_to_human=True  # Important for prompt compatibility
        )
